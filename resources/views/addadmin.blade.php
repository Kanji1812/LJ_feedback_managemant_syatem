...
<center>
	<u><h1 class="button2" style="font-family:cursive;">Add Admin Form</u></h1>
<form method="post" action="addadmin" style="background-color:lightgrey; color: darkred; margin-top: 200px; height:auto; padding-top: 30px; width:400px">
	@csrf
    ...
    <label>Role:</label>
	<br>
	<input style="border-radius:20px" type="text" name="role" placeholder="Enter Your Divison" value="Admin" readonly />
	<br><br>
