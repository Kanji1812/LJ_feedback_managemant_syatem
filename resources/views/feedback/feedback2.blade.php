<!-- This is a Second faaculty of the college to give the dash bord.  -->
<!-- this is a Second Feed-back for the meetu ma'am (pro:Python.). -->
<!DOCTYPE html>
<html lang="en">
...
<body class="back-login">
    <form class="center-form text-white" method='post' action='feedback2'>
		@csrf
        <div class="col12">
        ...
        <center>
        <img src="feedback/images/mj.jpg" style="height: 200px;">
        <h3><b><label for="Verbal response">Meetu ma'am</label><br></h3></b>
        </center>
        </div>
        <div class="col-12 space-aut">
            <p>1)How well did Meetu Ma'am explain programming concepts and Python syntax?</p>
        ...
        <div class="col-12 space-aut">
            <p>2) How effectively did Meetu Ma'am provide guidance and support for Python projects and assignments?</p>
        ...
        <div class="col-12 space-aut">
            <p>3) How approachable and helpful was Meetu Ma'am in answering student questions and addressing concerns?</p>
        ...
        <div class="col-12 space-aut">
            <p>4)How satisfied were you with the overall teaching and guidance provided by Meetu Ma'am in the Python course?</p>
        ...
        <div class="col-12 space-aut">
            <p>5) How satisfied were you with the overall teaching and Python skills of the Python faculty?</p>
        ...
        <center>
        <input type="hidden" value="MJ" name='faculty'>
